...
anandham = media.Movie("Anandham",
                      "It is story of a CSE dept gang who enjoyed a lot in\
                       their IV trip and their love, friendhsip and all",
...
vikram_vedha = media.Movie("Vikram Vedha",
			   ...
			   "https://upload.wikimedia.org/wikipedia/en/0/03/\
                           Vikram_Vedha_poster.jpg",
			   "https://www.youtube.com/watch?v=8rnTSgcAQus")


sanam_teri_kasam = media.Movie("Sanam Teri Kasam",
                               "It is a Love story with sad ending..\
                           Will make u cry",
